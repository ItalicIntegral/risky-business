...
pub fn build(b: *std.Build) void {
    ...
    const note_unit_tests = b.addTest(.{
        .root_source_file = b.path("src/Note/Note.zig"),
        .target = target,
        .optimize = optimize,
    });

    const run_note_unit_tests = b.addRunArtifact(note_unit_tests);
    ...
    const run_location_unit_tests = b.addRunArtifact(location_unit_tests);
    ...
    test_step.dependOn(&run_note_unit_tests.step);
